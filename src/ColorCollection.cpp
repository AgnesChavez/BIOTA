...
void ColorCollection::addColor(ofColor color) { colors.push_back(color); }
...
ofColor ColorCollection::getColorById(int id) { return colors.at(id); }

int ColorCollection::size() { return colors.size(); }
